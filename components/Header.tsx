        ...
        <nav>
          <ul className="flex items-center gap-7">
            <li>
              <Link
                href={"/#schools"}
                className={`inline-block px-5 py-3 rounded-[24px] flex items-center gap-[10px] hover:bg-grey-700 hover:text-white transition-all duration-2 ease-in-out ${donateActive}`}
              >
            ...
            <li>
              <Link
                href={"/tx-explorer"}
                className={`inline-block px-5 py-3 rounded-[24px] flex items-center gap-[10px] hover:bg-grey-700 hover:text-white transition-all duration-2 ease-in-out ${txActive}`}
              >
